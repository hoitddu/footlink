...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  const source = getAppDataSource() === "supabase" ? await getFeedDataSource(context) : undefined;

  return <FeedScreen initialContext={context} initialReferenceNow={referenceNow} source={source} />;
}
