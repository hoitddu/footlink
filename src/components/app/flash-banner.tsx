const flashMessages = {
  ...
  accepted: {
    ...
    text: "호스트가 요청을 승인했습니다. 오픈채팅이나 연락 링크를 확인해 보세요.",
  },
  confirmed: {
    tone: "bg-[#e4f6e8] text-[#1f7a38]",
    text: "참여가 확정되었습니다. 이제 경기 준비만 하면 됩니다.",
  },
  confirmation_cancelled: {
    tone: "bg-[#fff0d7] text-[#9a6111]",
    text: "확정 상태가 해제되었습니다. 다시 호스트와 연락을 확인해 주세요.",
  },
  rejected: {
    tone: "bg-[#f6f1f0] text-[#6b5852]",
    text: "요청이 마감되었거나 거절되었습니다. 다른 공석을 확인해 보세요.",
  },
  withdrawn: {
    tone: "bg-[#f6f1f0] text-[#6b5852]",
    text: "참여 요청을 취소했습니다.",
